...
var onGetCampaigns = function onGetCampaigns(event) {
  event.preventDefault();
  api.getCampaigns().done(ui.getCampaignsSuccess).fail(ui.failure);
};

var onGetEncounters = function onGetEncounters(event) {
  event.preventDefault();
  var campaignName = $('#reference-name').val();
  api.getEncounters(campaignName).done(ui.getEncountersSuccess).fail(ui.failure);
};

var onCreateCampaign = function onCreateCampaign(event) {
  event.preventDefault();
  console.log(event);
  var campaignName = $('#campaign-id').val();
  var campaignDay = $('#campaign-day').val();
  console.log(campaignName);
  console.log(campaignDay);
  api.createCampaign(campaignName, campaignDay).done(ui.createCampaignSuccess).fail(ui.failure);
};

var onCreateEncounter = function onCreateEncounter(event) {
  event.preventDefault();
  var campaignId = $('#encounter-campaignID').val();
  var encounterName = $('#encounter-name').val();
  var encounterCr = $('#encounter-cr').val();
  var encounterBooks = $('#encounter-books').val();
  var encounterDesc = $('#encounter-description').val();
  api.createEncounter(campaignId, encounterName, encounterCr, encounterBooks, encounterDesc).done(ui.createEncounterSuccess).fail(ui.failure);
};

var onUpdateCampaign = function onUpdateCampaign(event) {
  event.preventDefault();
  var campaignName = $('#campname').val();
  var updateName = $('#updateName').val();
  var updateDay = $('#updateDay').val();
  api.updateCampaign(campaignName, updateName, updateDay).done(ui.updateCampaignSuccess).fail(ui.failure);
};

var onUpdateEncounter = function onUpdateEncounter(event) {
  event.preventDefault();
  var campaignName = $('#campname-encounterUp').val();
  var encounterName = $('#encountname-encounterUp').val();
  var updateName = $('#updateName-encountUp').val();
  var updateCr = $('#updateCR').val();
  var updateBooks = $('#updateBooks').val();
  var updateDesc = $('#updateDesc').val();
  api.updateEncounter(campaignName, encounterName, updateName, updateCr, updateBooks, updateDesc).done(ui.updateEncounterSuccess).fail(ui.failure);
};

var onDeleteCampaign = function onDeleteCampaign(event) {
  event.preventDefault();
  var campaignName = $('#camp-delete').val();
  api.deleteCampaign(campaignName).done(ui.deleteCampaignSuccess).fail(ui.failure);
};

var onDeleteEncounter = function onDeleteEncounter(event) {
  event.preventDefault();
  var campaignName = $('#campName-delete').val();
  var encounterName = $('#encountName-delete').val();
  api.deleteEncounter(campaignName, encounterName).done(ui.deleteEncounterSuccess).fail(ui.failure);
};
...
var getCampaignsSuccess = function getCampaignsSuccess(data) {
  console.log(data);
...
var getEncountersSuccess = function getEncountersSuccess(data) {
  console.log(data);
...
var showCreates = function showCreates() {
...
var showEdits = function showEdits() {
...
var showDeletes = function showDeletes() {
...
var hidePops = function hidePops() {
  $('.camp-update-message').addClass('hidden');
  $('.encnt-update-message').addClass('hidden');
  $('.updated').addClass('hidden');
  $('.camp-created-message').addClass('hidden');
...
module.exports = {
  ...
  getCampaignsSuccess: getCampaignsSuccess,
  getEncountersSuccess: getEncountersSuccess,
  createCampaignSuccess: createCampaignSuccess,
  createEncounterSuccess: createEncounterSuccess,
  updateCampaignSuccess: updateCampaignSuccess,
  updateEncounterSuccess: updateEncounterSuccess,
  deleteCampaignSuccess: deleteCampaignSuccess,
  deleteEncounterSuccess: deleteEncounterSuccess,
...
var printCampaigns = function printCampaigns(campaigns) {
  for (var i = 0; i < campaigns.length; i++) {
    $('#campaignTable').append('<tr class="campaignRow">' + '<td>' + campaigns[i].name + '</td>' + '<td>' + campaigns[i].scheduled_day + '</td>' + '</tr>');
  }
};

var printEncounters = function printEncounters(encounters) {
  for (var i = 0; i < encounters.length; i++) {
    $('#encounterTable').append('<tr class="encounterRow">' + '<td>' + encounters[i].name + '</td>' + '<td>' + encounters[i].CR + '</td>' + '<td>' + encounters[i].books + '</td>' + '<td>' + encounters[i].description + '</td>' + '</tr>');
  }
};

module.exports = {
  printCampaigns: printCampaigns,
  printEncounters: printEncounters
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
var getEncounters = function getEncounters(data) {
  return $.ajax({
    method: 'GET',
...
var createCampaign = function createCampaign(campaignName, campaignDay) {
  return $.ajax({
    method: 'POST',
...
var createEncounter = function createEncounter(campaignId, encounterName, encounterCr, encounterBooks, encounterDesc) {
  return $.ajax({
    method: 'POST',
...
var updateCampaign = function updateCampaign(campaignName, updateName, updateDay) {
  return $.ajax({
    method: 'PATCH',
...
var updateEncounter = function updateEncounter(campaignName, encounterName, updateName, updateCr, updateBooks, updateDesc) {
  return $.ajax({
    method: 'PATCH',
...
var deleteCampaign = function deleteCampaign(campaignName) {
  return $.ajax({
    method: 'DELETE',
    url: app.host + '/users/' + app.user.id + '/campaigns/' + campaignName,
    headers: {
...
var deleteEncounter = function deleteEncounter(campaignName, encounterName) {
  return $.ajax({
    method: 'DELETE',
    url: app.host + '/users/' + app.user.id + '/campaigns/' + campaignName + '/encounters/' + encounterName,
    headers: {
